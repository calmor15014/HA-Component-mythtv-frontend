...
class MythTV:
    ...
    def video_artwork(self, pathname):
        return self._process_art_response('VideoMetadataInfo', 
                                    self._backend.get_video_artwork(pathname))
    
    def recording_artwork(self, startTime, channelId):
        return self._process_art_response('Program', 
                                    self._backend.get_recording_artwork(startTime, channelId))
